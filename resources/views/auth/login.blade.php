                    ...
                    <div class="card col-lg-4 mx-auto">
                        <div class="card-body px-5 py-5">
                            ...
                            <form action="{{route('login')}}" method="POST">
                                <input type="hidden" name="_token" value="chQBp8yRDOGpSIbBlQcLYK6s4oLWFtOt9Ik91Zm6">                                <div class="form-group">
                                ...
                                <p class="sign-up">Vous n'avez pas encore de compte ?<a href="/register"> Choisissez un forfait et s'abonner</a></p>
                            </form>
                        </div>
                    </div>
                </div>
